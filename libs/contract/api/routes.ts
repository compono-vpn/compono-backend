...
export const REST_API = {
    ...
    NODES: {
        ...
        EXPECTED_USERS: (uuid: string) =>
            `${ROOT}/${CONTROLLERS.NODES_CONTROLLER}/${CONTROLLERS.NODES_ROUTES.EXPECTED_USERS(uuid)}`,
    },
    USERS: {
        ...
        ACTIVE_VLESS_UUIDS: `${ROOT}/${CONTROLLERS.USERS_CONTROLLER}/${CONTROLLERS.USERS_ROUTES.ACTIVE_VLESS_UUIDS}`,
    },
    SUBSCRIPTION: {
